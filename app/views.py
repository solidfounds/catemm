...
from .forms import PrimerRegistroFORM, SegundoRegistroForm, OrderForm, EmailOdcsForm, RelacionPFprm
...
def enviar_email(request, cliente_id=None):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            message = 'Cliente Listo \n\n{}\'s  datos Orden 1:{}\n\n Orden 2:{}\n\n Orden 3: {}\n\n Total:{}  comments: {} '.format(
                cd['name'], allorder[0], allorder[1], allorder[2], posta['total_amount__sum'], cd['comments'], )
...
def dia(request, year, month, day):
    ...
    diass =  get_list_or_404(RelacionP, fecha__year=year,
                                        fecha__month=month,
                                        fecha__day=day,)
    return render(request, 'gaeladmin/dia.html', {'form': form,
                                                   'diass':diass
                                                  })
